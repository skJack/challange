...
class Model(nn.Module):
    ...
    def forward(self, img):
        ...
        cat_feat = torch.cat((rgb_feat3*weight_list[0], depth_feat3*weight_list[1], ir_feat3*weight_list[2]), 1)  # [64,640,14,14]
        cat_feat = torch.cat(( depth_feat3*weight_list[1], ir_feat3*weight_list[2]), 1)  # [64,640,14,14]
