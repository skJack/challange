...
def load_cisia_csfa_dev(root = '/media/sdc/datasets/Face-anti-spoofing/CASIA-CeFA/phase1',protoal = "4@1",img_size = 112,batch_size = 1,sample = '0020'):
    ...
    dev_data = CISIA_CeFA(root_path=root,txt_path=data_txt,transform=transformer_test,sample = sample)
...
def inference():
    ...
    if args.which=='test':
        ...
        data_loader = load_cisia_csfa_test(root = args.test_path,protoal=args.protoal,sample='0005',img_size = img_size,batch_size=2)
    elif args.which=='dev':
    ...
    for i,data in enumerate(data_loader):
        ...
        for i_batch in range(preds.shape[0]):
            ...
            f = open('submission/{}_{}_{}_submission.txt'.format(args.which,args.protoal,args.arch), 'a+')
